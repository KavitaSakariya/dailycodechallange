import '../iphone_14_three_screen/widgets/griddaytext_item_widget.dart';
        ...
        child: Scaffold(
            appBar: CustomAppBar(
                ...
                leading: AppbarImage1(
                    ...
                    margin: EdgeInsets.only(left: 17.h, top: 4.v, bottom: 14.v),
                    onTap: () {
                ...
                actions: [
                  AppbarImage2(
                      ...
                      margin: EdgeInsets.fromLTRB(19.h, 24.v, 19.h, 4.v))
                ]),
            body: Container(
                width: double.maxFinite,
                padding: EdgeInsets.only(left: 22.h, top: 83.v, right: 22.h),
                child: Column(
